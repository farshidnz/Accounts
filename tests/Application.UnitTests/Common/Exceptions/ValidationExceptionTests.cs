...
namespace Accounts.Application.UnitTests.Common.Exceptions
{
    public class ValidationExceptionTests
    {
        ...
        [Test]
        public void ValidationException_WithMessage_ShouldHaveMessage()
        {
            var actual = new ValidationException("Error in validation");

            actual.Message.Should().BeEquivalentTo("Error in validation");
        }
    }
}
